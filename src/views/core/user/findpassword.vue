  ...
  <section class="zkui-user-apply">
    ...
    <div>
      <group gap="1rem 0rem">
        ...
        <zk-phone-verifiy v-model="findPasswordInput.phoneVerificationCode"></zk-phone-verifiy>
      </group>
  ...
  export default {
    ...
    methods: {
      async findPassword () {
        ...
        console.dir(this.findPasswordInput.mobile.replace(/\s+/g, ''))
