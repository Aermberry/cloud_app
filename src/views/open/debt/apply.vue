<template>
  <section class="zkui-user-apply">
    ...
    <group title="债权人信息">
      ...
      <x-input title="债权人手机号" required placeholder="填写债权人手机号" mask="99999999999" :max="13" is-type="mobile" v-model="debtApiInput.DebteePhone"></x-input>
    ...
    <group title="债务人信息">
      ...
      <x-input title="债务人手机号" required placeholder="填写债务人手机号" mask="99999999999" :max="13" is-type="mobile" v-model="debtApiInput.DebtorPhone"></x-input>
