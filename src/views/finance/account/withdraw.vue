<template>
  <section class="zkui-user-account-withdraw">
    ...
    <group>
      ...
      <cell is-link link='/user/account/bankcard/add' v-if="bankcardShow">
        <span slot="title" style="color:#e4393c;">
          <span style="vertical-align:middle;">请先点击添加银行卡</span>
          <badge text="1"></badge>
        </span>
      </cell>
