      ...
      <div class="weui-uploader">
        ...
        <div class="weui-uploader__bd">
          <ul class="weui-uploader__files" id="uploaderFiles">
            <li class="weui-uploader__file eui-uploader__file_statu zk-border" v-for="(file, index) in files" :key="index" :style="'background-image:url('+file.thumb+')'">
            </li>
          </ul>
          <div class="weui-uploader__input-box">
            <uploadInput class="btn btn-primary" post-action="/upload/post" :extensions="extensions" :accept="accept" :multiple="true" :size="1024 * 1024 * 10" :drop="true" v-model="files" @input-filter="inputFilter" @input-file="inputFile" ref="upload">
