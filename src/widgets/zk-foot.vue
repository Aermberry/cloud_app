    ...
    <div class="zkfoot footer">
      <ul class="clear">
        ...
        <router-link to="/order/goods" tag="li" class="footer_li">
          ...
          <section class="li_text" :class="$route.path.indexOf('goods') !== -1 ? 'brand' : 'metal' ">订单</section>
        </router-link>
        <router-link to="/order/Deliver" tag="li" class="footer_li">
          <section class="li_svg">
